...
protected:
	...
	bool esSubABBAvl(Nodo *raizSubarbol);
	Nodo * leerSubarbol(Nodo *padre);
	int maxAltura(Nodo *raizSubarbol);
	int minAltura(Nodo *raizSubarbol);
	//Nodo* buscarNodoNoOrdenado(Nodo* recorrido, Nodo *nodoParaBuscar);
};
